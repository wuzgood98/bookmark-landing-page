        ...
        <div className='p-9 flex flex-col gap-10 items-center sm:flex-row sm:justify-between sm:max-w-4xl sm:mx-auto'>
          <div className="flex flex-col gap-10 items-center sm:flex-row sm:gap-20">
            ...
            <div className='text-white flex flex-col sm:flex-row gap-5 uppercase tracking-widest transition-colors'>
              <a href="#" aria-label='Read more about features' className='hover:text-softRed transition-colors'>features</a>
              <a href="#" aria-label='Read more about pricing' className='hover:text-softRed transition-colors'>pricing</a>
              <a href="#" aria-label='Read more about contact' className='hover:text-softRed transition-colors'>contact</a>
            </div>
          </div>
          <div className='flex gap-12 items-center'>
            <a href="#" aria-label='Visit our facebook page' className='group'>
            ...
            <a href="#" aria-label='Visit our twitter page' className='group'>
